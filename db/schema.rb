...
ActiveRecord::Schema.define(version: 2021_08_23_112302) do
  ...
  create_table "store_products", force: :cascade do |t|
    ...
    t.index ["name"], name: "index_store_products_on_name", unique: true
    t.index ["segment_id"], name: "index_store_products_on_segment_id"
  end

  create_table "store_segments", force: :cascade do |t|
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.string "name", null: false
  ...
  add_foreign_key "store_products", "store_segments", column: "segment_id", on_delete: :restrict
end
